/*:
 ...
 Mikutap is a music game originally made by *daniwell* for web. The entire view in the game is divided into a number of neat little squares, each one corresponds to a pitch and a fifty-tone in Japanese. Touching a square with your finger will send out a corresponding tone and lyrics, and you can form a song melody by sliding continuously. Coupled with a nice set of fingertip animations, it’s just awesome.
